...
class PackageDetail extends StatefulWidget {
  ...
  final int lat;
  final int lang;
  const PackageDetail({super.key, required this.data, required this.lat, required this.lang});
                                      ...
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: Container(
                                            ...
                                            child:  Center(child: Text("${widget.data.discount}%Off",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)),
                                          ),
                                        ),
                                      ],
                                    ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          appText(
                                            title: '${widget.data.service?[index].subService?.first.timeTaken} Min',
                                          )
                                        ],
                                      ),
                                      // Row(
                                      ...
                                      Row(
                                        children: [
                                          appText(
                                            title: '₹${calculatePrice(widget.data.price,widget.data.discount,)}',
                                            fontSize: 14,
                                            fontWeight: FontWeight.bold,
                                          ),
                                          const SizedBox(
