                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          appText(
                                            title:
                                            provider.showMemberShipDetails.membership?.membershipName ?? '',
                                            fontSize: 14,
                                            fontWeight: FontWeight.bold,
                                          ),
                                          const SizedBox(
                                          ...
                                          appText(
                                            title: provider.showMemberShipDetails.membership?.membershipName??'',
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.grey,
                                          ),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              // appText(
                                              //   title:
                                              //       '${provider.showMemberShipDetails.shopName. Min',
                                              // )
                                            ],
                                          ),
                                          // Row(
                                            ...
                                            children: [
                                              appText(
                                                title: '₹${calculatePrice(
                                                  provider.showMemberShipDetails.membership?.price,
                                                  provider.showMemberShipDetails.membership?.offer,
                                                )}',
                                                fontSize: 14,
                                                fontWeight: FontWeight.bold,
                                              ),
